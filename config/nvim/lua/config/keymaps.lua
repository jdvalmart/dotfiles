...
vim.keymap.set("n", "<leader>ml", ":MagmaEvaluateLine<CR>", { desc = "Eval Line" })
vim.keymap.set("v", "<leader>mv", ":<C-u>MagmaEvaluateVisual<CR>", { desc = "Eval Selection" })
vim.keymap.set("n", "<leader>mo", ":MagmaShowOutput<CR>", { desc = "Show Output" })
vim.keymap.set("n", "<leader>mr", ":MagmaRestart<CR>", { desc = "Restart Kernel" })
----- Tmux Navigation ------
...
-- Line navigation (safe layout, keeps counts)

vim.keymap.set({ "n", "v", "o" }, "A", "0", {
  desc = "Go to start of line",
})

vim.keymap.set({ "n", "v", "o" }, "Ñ", "$", {
  desc = "Go to end of line",
})

vim.keymap.set("i", "jf", "<Esc>") -- Salir del modo insert

-- Terminal (LazyVim / Snacks)
