...
require("lazy").setup({
  spec = {
    ...
    -- Language support plugins (AI/ML Stack)
    { import = "lazyvim.plugins.extras.lang.json" },
    { import = "lazyvim.plugins.extras.lang.markdown" },
    { import = "lazyvim.plugins.extras.lang.python" }, -- Python (principal)
    { import = "lazyvim.plugins.extras.lang.typescript" }, -- TypeScript/JS
    ...
    -- blink.cmp deshabilitado (conflicta con la config personalizada)
    ...
    -- Python/ML tools
    { import = "lazyvim.plugins.extras.lang.python" }, -- ya tiene ruff y pytest
